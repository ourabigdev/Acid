...
void OverlayDebug::UpdateObject() {
	...
	textFrameTime.SetTextColour(paused ? Colour::Blue : Colour::Lime);
	textFps.SetTextColour(paused ? Colour::Blue : Colour::Lime);
	textUps.SetTextColour(paused ? Colour::Blue : Colour::Lime);
